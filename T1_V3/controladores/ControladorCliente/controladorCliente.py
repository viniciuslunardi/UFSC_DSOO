...
class ControladorCliente():
    def __init__(self, controlador_principal):
        ...
        self.__clientes.append(Cliente(1, 'Rafael', '4994932', Endereco('rua', 12, 'teste')))
        ...
        if botoes == 'Entrar':
            for cliente in self.__clientes:
                if cliente.cpf == int(dados[0]) and cliente.senha == int(dados[1]):
                    ...
                    self.__main_view.show_msg('Error', 'Cliente nao encontrado')
        ...
        try:
            if isinstance(novo_cliente, Cliente):
                if self.existe_cliente(novo_cliente):
                    ...
                    str(novo_cliente.endereco), novo_cliente.senha)
                    cliente_db.__del__()
    ...
    def ve_dados(self):
        ...
        self.__main_view.show_msg('Dados todos', str(self.__clientes))
