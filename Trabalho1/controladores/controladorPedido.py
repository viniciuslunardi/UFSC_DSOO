...
class ControladorPedido:
    ...
    complemento: str="", cep: int=88040320):
        ...
        self.__cliente['nome'] = c1.nome
        self.__cliente['endereco'] = c1.endereco
        self.__cliente['telefone'] = c1.telefone
    ...
    def registra_pedido_novo(self, p1: Pedido):
        ...
        teste = self.__tela_cliente.cadastro()
        self.__pedido['cliente'] = teste
